...
if (isset($_SESSION['SignIn'])) {
    ...
    if (isset($_POST['SignIn'])) {
        ...
        $Select = mysqli_query($Connection, "SELECT `UserID` , `Username` , `Password` FROM `tblusers` WHERE `Username` = '$UserName' AND `Password` = '$Password' ");
        $ResultSelect = mysqli_fetch_assoc($Select);
        if (count($Errors) === 0) {
            if ($ResultSelect && $ResultSelect['Username'] == $UserName && $ResultSelect['Password'] == $Password) {
                $_SESSION['SignIn'] = $ResultSelect['UserID'];
...
?>
    ...
    <head>
        ...
        <title>فرم ورود ورود کاربر</title>
    </head>
    ...
    <body class="d-flex align-items-center py-4 bg-body-tertiary">
        ...
        <main class="form-signin w-100 m-auto">
            <form action="SignIn.php" method="post">
                ...
                <button class="btn btn-primary w-100 py-2" type="submit" name="SignIn">
                    Sign in
                </button>
