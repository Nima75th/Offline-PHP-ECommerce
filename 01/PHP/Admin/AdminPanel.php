...
if (isset($_SESSION['Admin_SignIn'])) {
    $Select = mysqli_query($Connection, "SELECT `ProductID` , `Productname` , `ProductPrice` , `ProductDescription` FROM `tblproducts` ORDER BY ProductID DESC");
    $SelectUser = mysqli_query($Connection, "SELECT * FROM `tblusers`");
        ...
        <div class="row">
                ...
                <div
                    ...
                    <div
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2" href="UsersList.php">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2" href="ProductsList.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h3 class="h2">تعداد محصولات موجود :<?php echo mysqli_num_rows($Select); ?></h3>
                 ...
                 <table style="text-align: center;" class="table table-dark table-hover">
                        ...
                        <tr class="table-light">
                            <td><?php echo $ResultSelect['ProductID']; ?></td>
                            <td><?php echo  $ResultSelect['Productname']; ?></td>
                            <td><?php echo  $ResultSelect['ProductDescription']; ?></td>
                            <td><?php echo  number_format($ResultSelect['ProductPrice']); ?></td>
                            
                            <td>
                                <a href="Edit.php"><svg width="30" height="30" fill="currentColor" viewBox="0 0 16 16">
                                        <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                        <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z" />
                                    </svg></a>
                            </td>
                            <td>
                                <a href="Delete.php"><svg width="30" height="30" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <div
                    class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h3 class="h2">اطلاعات کاربران </h3>
                 ...
                 <table style="text-align: center;" class="table table-dark table-hover">
                        ...
                        <tr class="table-light">
                            ...
                            <td><?php echo  number_format(mysqli_num_rows($SelectUser)); ?></td>
