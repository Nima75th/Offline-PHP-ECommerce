...
if (isset($_SESSION['Admin_SignIn'])) {
    ...
    if (isset($_GET['ProductId']) && filter_var($_GET['ProductId'], FILTER_VALIDATE_INT)) {
        ...
        if ($ResultSelect) {
            ...
            $ProductDescription = $ResultSelect['ProductDescription'];
            $ProductImageName = $ResultSelect['ProductImageName'];
            ...
            if (isset($_POST['EditProduct'])) {
                ...
                $ProductImageName = mysqli_real_escape_string($Connection, $_POST['ProductImageName']);

                if (empty($ProductName)) {
                    array_push($Errors, 'عنوان محصول نمیتواند خالی باشد');
                }
                ...
                if (empty($ProductImageName)) {
                    array_push($Errors, 'نام عکس محصول نمیتواند خالی باشد');
                }

                if (count($Errors) === 0) {
                    mysqli_query($Connection, "UPDATE `tblproducts` SET `ProductName` ='$ProductName' , `ProductPrice` = '$ProductPrice', `ProductDescription` = '$ProductDescription', `ProductImageName` = '$ProductImageName' WHERE `ProductID` = '$ProductID'");
...
?>
            ...
            <body class="d-flex align-items-center py-4 bg-body-tertiary">
                ...
                <main class="form-signin w-100 m-auto">
                    <form action="Edit.php?ProductId=<?php echo $ResultSelect['ProductID']; ?>" method="post">
                        ...
                        <div class="form-floating" style="margin-bottom: 20px;">
                            <input
                                type="text"
                                class="form-control"
                                value="<?php echo $ProductImageName; ?>"
                                id="floatingInput"
                                name="ProductImageName"
                                placeholder="UserName" />
                            <label for="floatingInput">Product Image Name</label>
                        </div>
                        <button class="btn btn-primary w-100 py-2" type="submit" name="EditProduct">
                            Edit Product
                        </button>
