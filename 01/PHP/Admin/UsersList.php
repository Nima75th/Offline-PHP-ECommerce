...
if (isset($_SESSION['Admin_SignIn'])) {
     ...
     $Select = mysqli_query($Connection, "SELECT `UserID` , `Username` , `Email` , `FirstAndLastName`, `MobileNumber`, `Address` FROM `tblusers` ORDER BY UserID DESC");
            ...
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    <div
                        ...
                        <h3 class="h2">تعداد کاربران  :<?php echo mysqli_num_rows($Select); ?></h3>
                    ...
                    <table style="text-align: center;" class="table table-dark table-hover">
                        ...
                        <tr class="table-light">
                            <td><?php echo  number_format ($ResultSelect['UserID']); ?></td>
                            <td><?php echo  $ResultSelect['Username']; ?></td>
                            <td><?php echo  $ResultSelect['Email']; ?></td>
                            <td><?php echo  $ResultSelect['FirstAndLastName']; ?></td>
                            <td><?php echo  number_format($ResultSelect['MobileNumber']); ?></td>
                            <td><?php echo  $ResultSelect['Address']; ?></td>
                           
                            <td>
                                <a href="DeleteUser.php?UserID= <?php echo $ResultSelect['UserID']; ?> "><svg width="30" height="30" fill="currentColor" viewBox="0 0 16 16">
