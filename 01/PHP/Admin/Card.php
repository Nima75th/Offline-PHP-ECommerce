        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div style="text-align: right;" class="album py-5 bg-body-tertiary">
                        <div class="container">
                            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">

                                <?php

                                $ProductsQuery = mysqli_query($Connection, "SELECT * FROM `tblcard` ORDER BY ProductID DESC");
                                while ($Product = mysqli_fetch_assoc($ProductsQuery)) {
                                ?>
                                    <div class="col">
                                        <div class="card shadow-sm h-100 border-0">
                                            <img src="uploads/<?php echo $Product['ProductImageName']; ?>" class="card-img-top" style="height: 250px; object-fit: cover; border-radius: 8px 8px 0 0;" alt="Product Image">
                                            <div class="card-body">
