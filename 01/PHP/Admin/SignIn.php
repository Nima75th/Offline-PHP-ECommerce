...
define('ADMIN_PASSWORD','2189');
if (isset($_POST['SignIn'])) {
    $UserName =$_POST['UserName'];
    $Password = $_POST['Password'];

    if (empty($UserName)) {
        array_push($Errors, 'نام کاربری مدیر نمیتواند خالی باشد');
    }
    if (empty($Password)) {
        array_push($Errors, 'پسورد مدیر نمیتواند خالی باشد');
    }
    ...
    if (count($Errors) === 0) {
        if (ADMIN_USERNAME == $UserName && ADMIN_PASSWORD == $Password) {
            ...
            array_push($Errors, 'نام کاربری یا رمز عبور مدیر اشتباه است');
        }
    }
}
?>
...
<head>
    ...
    <title>فرم ورود ورود مدیر</title>
</head>
